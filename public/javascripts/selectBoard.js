...
function selectBoard_initEvent() {
	selectBoardObj.btnElements.modify.addEventListener(
		'click',
		selectBoard_onClickModifyBtn
	);
	selectBoardObj.btnElements.delete.addEventListener(
		'click',
		selectBoard_onClickDeleteBtn
	);
	selectBoardObj.btnElements.modifyOk.addEventListener(
		'click',
		selectBoard_onClickModifyOkBtn
	);
	selectBoardObj.btnElements.cancel.addEventListener(
		'click',
...
function selectBoard_onClickModifyBtn(e) {
	if (!selectBoardObj.summerNoteElements.$editor)
		selectBoard_initSummerNote();
...
// 버튼 상태 변경
function selectBoard_setBtnShow(
	isModify = false,
	isDelete = false,
	isModifyOk = false,
	isCancel = false
