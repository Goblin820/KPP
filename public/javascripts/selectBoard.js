		...
		success: function (res) {
			if (res.result == 'success') {
				Swal.fire({
					...
					// selectBoardObj.titleElements.$span.innerText = selectBoardObj.data.title;
					// selectBoardObj.textElements.$standard.innerHTML = selectBoardObj.data.text;

					// selectBoardObj.titleElements.$span.hidden = false;
					// selectBoardObj.titleElements.$input.hidden = true;

					// selectBoardObj.textElements.$standard.hidden = false;
				});
			}
		},
	});
